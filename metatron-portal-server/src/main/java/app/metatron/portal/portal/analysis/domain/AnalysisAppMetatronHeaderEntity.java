 ...
 */
@Entity
@Table(name = "mp_an_app_metatron_header")
public class AnalysisAppMetatronHeaderEntity extends AbstractEntity implements INavigable {
    ...
    public String getUrl() {
        if(this.type == Type.WORKBOOK) {
            return this.workbookSharePath + this.contentsId;
        } else if(this.type == Type.DASHBOARD) {
