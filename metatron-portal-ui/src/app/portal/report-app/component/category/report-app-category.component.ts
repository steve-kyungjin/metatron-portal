...
@Component({
	selector: 'report-app-category',
	templateUrl: './report-app-category.component.html'
})
export class ReportAppCategoryComponent extends AbstractComponent implements OnInit, OnDestroy, OnChanges {
