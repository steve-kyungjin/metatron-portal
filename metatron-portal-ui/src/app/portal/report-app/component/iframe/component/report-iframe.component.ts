...
export class ReportIframeComponent extends AbstractComponent implements OnInit, OnDestroy {
	...
	private extractApp: ReportExtractAppComponent;
	...
	private openWindow() {
		window.open(`http://${window.location.hostname}:${window.location.port}/view/new-window/report-app/my-app/${this.appId}`, `${this.appId}`)
	}
