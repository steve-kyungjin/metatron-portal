...
@Component({
	selector: '[community-list-main2]',
	templateUrl: './community-list-main2.component.html'
})
export class CommunityListMain2Component extends CommunityListComponent implements OnInit, OnDestroy {
