...
@Component({
	selector: 'community-detail2',
	templateUrl: './community-detail2.component.html'
})
export class CommunityDetail2Component extends AbstractComponent implements OnInit, OnDestroy {
