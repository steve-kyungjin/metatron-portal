...
@Component({
	selector: 'community-management2',
	templateUrl: './community-management2.component.html'
})
export class CommunityManagement2Component extends AbstractComponent implements OnInit, OnDestroy {
