...
export namespace AnalysisApp {
	...
	export class Main {
		...
		// 분석 앱 목록
		public analysisAppList: ListContent;
		// 카테고리 목록
	 ...
	 */
	export class CreateAnalysisAppPageParameter {
		public type?: AnalysisApp.HeaderType;
		public id?: string;
	}
