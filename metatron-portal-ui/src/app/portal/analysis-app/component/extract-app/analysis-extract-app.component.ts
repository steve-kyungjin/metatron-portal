...
@Component({
	selector: '[analysis-extract-app]',
	templateUrl: './analysis-extract-app.component.html'
})
export class AnalysisExtractAppComponent extends AbstractComponent implements OnInit, OnDestroy {
	...
	constructor(protected elementRef: ElementRef,
				...
				private appService: AnalysisAppService,
	...
	public init(id: string) {
		...
		this.appService
			...
			.then((result) => {
				...
				this.saveAppName(result.data.analysisApp.appNm);
				this.saveExtractParseParamDatasourceId(result.data.analysisApp.extractHeader.dataSource.id);
				this.saveExtractParseParamSql(result.data.analysisApp.extractHeader.sqlTxt);
